...
namespace Player_shuxing
{
    class Player
    {
        ...
        public int Player_HP = 100;//当前HP
        public int Player_Max_HP = 100;//最大HP
        public int Player_Attack = 5;//攻击力
    }
    ...
    class diren
    {
        ...
        public int diren_give_Exp = 0;//经验
        public int diren_give_Gold = 0;//金币
        public int diren_HP = 100;//当前HP
        public int diren_Max_HP = 100;//最大HP
        public int diren_Attack = 5;//攻击力
    }
}
